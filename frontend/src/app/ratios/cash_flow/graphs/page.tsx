...
export default function RatiosCashFlowGraphsPage() {
        ...
        {!hasSymbol && !symbol && (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <p className="text-lg font-bold text-slate-300 font-inter">
              Cash Flow Ratio Charts
            </p>
            <p className="mt-2 text-sm text-[#475569] font-inter">
              Select a company to view cash flow ratio trend charts.
            </p>
          </div>
        )}
            ...
            {symbol && (
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-xs text-[#475569] font-inter">
                  Cash Flow Ratios · Trend Analysis
                </span>
              </div>
            )}
