...
export default function RatiosFinancialPositionGraphsPage() {
        ...
        {!hasSymbol && !symbol && (
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            <p className="text-lg font-bold text-slate-300 font-inter">
              Financial Position Ratio Charts
            </p>
            <p className="mt-2 text-sm text-[#475569] font-inter">
              Select a company to view financial position ratio trend charts.
            </p>
          </div>
        )}
            ...
            {symbol && (
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-xs text-[#475569] font-inter">
                  Financial Position Ratios · Trend Analysis
                </span>
              </div>
            )}
