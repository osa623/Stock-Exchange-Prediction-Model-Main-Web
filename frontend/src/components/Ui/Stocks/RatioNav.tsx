...
export default function MainNav() {
  ...
  const navItems = [
    { name: "Income Statement", path: "/ratios/income" },
    { name: "Financial Position", path: "/ratios/financial_position" },
    { name: "Cash Flow", path: "/ratios/cash_flow" },
  ];
